...
- Shard wave u5 still in progress; u4 pass @ shard 7079d02 (not merged); u6 pass @ 75d23f4 (not merged); u7 pass @ 7235ae1 (not merged)
- U5 must wire player-log.ts to use tokenized log_url (U4 dependency)
