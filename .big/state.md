...
- [x] Next.js: no heartbeat on failed load; stop on unmount; recovery covers segment/scrub paths *(U5 shard @ f117f3e / 375c47a)*
- [x] Proxy forwards client IP; LAN gate meaningful in web mode *(U4 shard @ 7079d02)*
...
| 4 | HTTP/proxy ACL | parallel shard | big/media-player-fix--u4 | `C:\Users\willi\Documents\Python\AnimeManager\.worktrees\media-player-fix--u4` | pass (7079d02) |
| 5 | Next.js load/recovery | parallel shard | big/media-player-fix--u5 | `C:\Users\willi\Documents\Python\AnimeManager\.worktrees\media-player-fix--u5` | pass (f117f3e / 375c47a) |
...
- Shard wave u4/u5/u6/u7 pass on shards; merge into hub pending
