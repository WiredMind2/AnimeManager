...
try:
    from ..classes import (Anime, AnimeList, Character, Item, LockWrapper,
                           NoneDict)
    ...
    from classes import (Anime, AnimeList, Character, Item, LockWrapper,
                         NoneDict)
    from db_managers.base import BaseDB
    from logger import Logger, log
    ...
    class QueryCache:
        ...
        def invalidate_table(self, table_name):
            ...
            for key in self.cache.keys():
                # Simple heuristic: if table name appears in key, invalidate
